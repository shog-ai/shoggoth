...
result_t gen_api_docs() {
  ...
  template_t *head_template = create_template(
      ...
      "{\"title\": \"Shoggoth API Reference\", \"description\": \"Shoggoth is a peer-to-peer, anonymous network for publishing and distributing open-source code, Machine Learning models, datasets, and research papers.\", \"og_url\": \"/explorer/static/img/og/docs_api.png\", \"is_api\": true}");
