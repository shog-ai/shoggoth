...
result_t gen(char *source_path, char *destination_path, gen_type_t gen_type) {
  ...
  char *head_data = NULL;
  if (gen_type == DOCS) {
    head_data = "{\"title\": \"Shoggoth Documentation\", \"description\": \"Shoggoth is a peer-to-peer, anonymous network for publishing and distributing open-source code, Machine Learning models, datasets, and research papers.\", \"og_url\": \"/explorer/static/img/og/docs.png\", \"url\": \"/explorer/docs\", \"is_docs\": true}";
  } else if (gen_type == SONIC) {
    head_data =
        "{\"title\": \"Sonic — Shoggoth Documentation\", \"description\": \"Sonic is an HTTP library for the C programming language.\", \"og_url\": \"/explorer/static/img/og/sonic.png\", \"url\": \"/explorer/docs/sonic\", \"is_docs\": true}";
  } else if (gen_type == CAMEL) {
    head_data =
        "{\"title\": \"Camel — Shoggoth Documentation\", \"description\": \"Camel is a testing framework for the C programming language.\", \"og_url\": \"/explorer/static/img/og/camel.png\", \"url\": \"/explorer/docs/camel\", \"is_docs\": true}";
  } else if (gen_type == TUWI) {
    head_data =
        "{\"title\": \"Tuwi — Shoggoth Documentation\", \"description\": \"Tuwi is a terminal user interface framework written in the C programming language.\", \"og_url\": \"/explorer/static/img/og/tuwi.png\", \"url\": \"/explorer/docs/tuwi\", \"is_docs\": true}";
  } else {
